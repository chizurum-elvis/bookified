        ...
        <div className='library-hero-card'>
            <div className='library-hero-content'>
                ...
                <div className='library-hero-text'>
                    ...
                    <p className='library-hero-description'>Convert your books into interactive AI conversations. <br className='hidden md:block' />Listen, learn, and discuss your favourite reads.</p>
                    <Link 
                        href="/books/new"                     className='library-cta-primary mt-4 flex items-center justify-center'>
